...
public class VisualAnimal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Crea Un Nuevo Animal");

        jLabel2.setFont(new java.awt.Font("Gill Sans Ultra Bold", 1, 11)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 102));
        jLabel2.setText("Pulse las caracteristicas del animal ");
        ...
        jLabel3.setFont(new java.awt.Font("Gill Sans Ultra Bold", 1, 11)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(51, 204, 0));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("¿Qué animal es? Ej.(Perro, gato, vaca)");

        jLabel4.setFont(new java.awt.Font("Arial", 1, 11)); // NOI18N
        jLabel4.setText("Come Carne y Hierbas");

        jLabel5.setFont(new java.awt.Font("Arial", 1, 11)); // NOI18N
        jLabel5.setText("Come solo Hiervas");

        jButton1.setFont(new java.awt.Font("Gill Sans Ultra Bold", 1, 11)); // NOI18N
        jButton1.setText("Resgresar");
